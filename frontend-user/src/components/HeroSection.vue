...
.hero-greeting {
  font-size: $font-size-lg; color: $text-secondary; margin-bottom: $spacing-sm; font-weight: 400;
...
.hero-desc {
  font-size: $font-size-md; color: $text-secondary; max-width: 500px; margin: 0 auto $spacing-xl; line-height: 1.8;
  .dark-mode & { color: $text-light; }
}
