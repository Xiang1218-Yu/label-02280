  ...
  <section class="featured-section">
    <div class="container">
      ...
      <div class="features-grid">
        <div v-for="(feature, index) in features" :key="index" class="feature-card fade-in" v-lazy>
...
.feature-card {
  ...
  p {
    font-size: $font-size-sm; color: $text-secondary; line-height: 1.7; margin-bottom: $spacing-md;
